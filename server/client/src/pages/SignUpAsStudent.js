    ...
    <div className="h-screen">
      <section className="bg-white dark:bg-gray-900">
        <div className="flex justify-center min-h-screen">
          <div
            className="hidden bg-cover lg:block lg:w-4/5"
            style={{
              backgroundRepeat: "no-repeat",
              objectFit: "contain",
              backgroundImage:
                'url("https://img.freepik.com/free-photo/portrait-three-smiling-graduate-friends-graduation-robes-university-campus-with-diploma_496169-1363.jpg?w=900&t=st=1671379952~exp=1671380552~hmac=03c5372d5ffc0e4f8e7074db3860893972de19536fd768777b5c7e843b94184f")',
            }}
          ></div>
              ...
              <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    placeholder="Snow"
                    className="required:border-red-500  block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                  />
                </div>
